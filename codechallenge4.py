...
Email_address = input("What email will you use (Must end with '@gmail.com') ---> ")
Acc_pass = input("What is your password ---> ")
...
if not Email_address.endswith("@gmail.com"):
    ...
    if Login_email == Email_address and Login_pass == Acc_pass:
